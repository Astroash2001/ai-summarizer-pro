...
const API_BASE = "https://ai-summarizer-pro-omy1.onrender.com/api";
      ...
      <section className="gradient-hero pt-32 pb-20 flex-1">
        <div className="container-custom">
          ...
          <p className="text-body text-center max-w-3xl mx-auto mb-12">
            Upload a document and ask questions about it. AI will answer based
              ...
              <div className="bg-gradient-to-br from-cyan-100/90 to-blue-200/80 rounded-3xl p-16 shadow-2xl border border-white/20 backdrop-blur-sm">
                <div className="flex flex-col items-center justify-center space-y-8">
                  <div className="relative">
                    {isUploading ? (
                      <Loader2
                        className="w-32 h-32 text-blue-500 animate-spin"
                        strokeWidth={1.5}
                      />
                    ) : (
                      <Upload
                        className="w-32 h-32 text-blue-400/80"
                        strokeWidth={1}
                      />
                    )}
                  </div>
                ...
                <div className="bg-slate-800 p-4 border-t border-slate-700">
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      disabled={
                        isSending || !inputMessage.trim() || !extractedText
                      }
